...
<details>
<summary><strong><u>🆕 新功能（10 項）</u></strong></summary>

<details>
<summary><strong>自訂登入頁從未接上路由，改為伺服器端 session 登入</strong></summary>
...
<details>
<summary><strong>Discord／Telegram 通知新增網頁設定欄位</strong></summary>
...
<details>
<summary><strong>Dashboard 新增 Cookie 線上編輯欄位</strong></summary>
...
<details>
<summary><strong>新增讀取其他版本設定檔並比對差異匯入</strong></summary>
...
<details>
<summary><strong>新增取得當前新番更新時間功能</strong></summary>
...
<details>
<summary><strong>新增資料庫整頓功能</strong></summary>
...
<details>
<summary><strong>新增手動任務暫存紀錄，意外中斷後自動重新提交</strong></summary>
...
<details>
<summary><strong>新增掃描集數勾選下載，取代下拉選單</strong></summary>
...
<details>
<summary><strong>新增 ja3/akamai 自動相容性檢測</strong></summary>
...
<details>
<summary><strong>新增裝置ID過期自動偵測與自動重新申請</strong></summary>
...
<details>
<summary><strong><u>🐛 BUG 修正（9 項）</u></strong></summary>

<details>
<summary><strong>任務監控頁缺漏導覽列項目、死連結與字體比例不一致</strong></summary>
...
<details>
<summary><strong>登出在反向代理／Cloudflare Tunnel 環境下按了沒反應</strong></summary>
...
<details>
<summary><strong>大量下載時 Dashboard 網頁可能卡死變白畫面</strong></summary>
...
<details>
<summary><strong>下載期間 Dashboard 反應變慢、切頁白畫面轉圈</strong></summary>
...
<details>
<summary><strong>裝置ID觸發過一次裝置驗證異常後持續失敗</strong></summary>
...
<details>
<summary><strong>`config_version` 長期未更新，舊設定檔讀取崩潰</strong></summary>
...
<details>
<summary><strong>偵測不到 Dashboard 資料夾時設定物件互相污染崩潰</strong></summary>
...
<details>
<summary><strong>`range` 下載模式輸出字串混用簡體字導致崩潰</strong></summary>
...
<details>
<summary><strong>中文配音／特別篇集數被誤歸類到正篇資料夾</strong></summary>
...
<details>
<summary><strong>手動任務／排程提交後先顯示暫定排隊狀態，避免重複提交</strong></summary>
...
<details>
<summary><strong>移除已停止維護的 Plex 自動更新／命名功能</strong></summary>
...
<details>
<summary><strong>版本號由 v25.1.3 調整為 v25.1.4</strong></summary>
