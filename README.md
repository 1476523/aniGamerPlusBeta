...
> 以官方 [miyouzi/aniGamerPlus v24.6](https://github.com/miyouzi/aniGamerPlus/releases/tag/v24.6) 原始碼為基準的客製修改版本，目前版本為 **v25.1.6**。
...
**「其他」工具**：取得當前新番更新時間／資料庫整頓／重新檢查所有排程更新／讀取其他版本設定檔／監視公告與機動調整時間（v25.1.6 新增）
...
**手動任務新增「更改名稱」**（v25.1.6 新增，原理與 sn_list.txt 的 `<重新命名>` 標籤相同）
...
**資料庫整頓改為勾選候選清單**（v25.1.6，掃描後列出候選項目讓使用者勾選確認才刪除，不再自動刪除）
